	...
	private function isBlockedGlobal(string $ip): bool
	{
		...
		try {
			return (bool) $this->cache->get($ck, function (ItemInterface $item) use ($ip) {
				...
				$ttl = (int) ($status['ip_block_ttl'] ?? 24);<?php
